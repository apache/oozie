...
public class TestWorkflowJobGetActionsJPAExecutor extends XDataTestCase {
    Services services;
    ...
    private void _testGetActions(String jobId) throws Exception {
        ...
        WorkflowJobGetActionsJPAExecutor actionsGetCmd = new WorkflowJobGetActionsJPAExecutor(jobId);
