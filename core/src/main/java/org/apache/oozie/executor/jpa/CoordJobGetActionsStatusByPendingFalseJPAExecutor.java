 ...
 */
public class CoordJobGetActionsStatusByPendingFalseJPAExecutor implements JPAExecutor<List<CoordinatorAction.Status>> {

    private String coordJobId = null;

    public CoordJobGetActionsStatusByPendingFalseJPAExecutor(String coordJobId) {
    ...
    public List<CoordinatorAction.Status> execute(EntityManager em) throws JPAExecutorException {
        try {
            Query q = em.createNamedQuery("GET_COORD_ACTIONS_STATUS_BY_PENDING_FALSE");
