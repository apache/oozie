...
public class TestCoordJobGetActionsJPAExecutor extends XDataTestCase {
    Services services;
    ...
    private void _testGetActions(String jobId, String actionId) throws Exception {
        JPAService jpaService = Services.get().get(JPAService.class);
        assertNotNull(jpaService);
        CoordJobGetActionsJPAExecutor actionGetCmd = new CoordJobGetActionsJPAExecutor(jobId);
