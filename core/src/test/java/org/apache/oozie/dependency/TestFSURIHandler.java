...
public class TestFSURIHandler extends XFsTestCase {
    ...
    public void testCreate() throws Exception {
        ...
        URIHandler handler = uriService.getURIHandler(path.toUri());
        assertTrue(handler.create(path.toUri(), conf, getTestUser()));
    ...
    public void testDelete() throws Exception {
        ...
        assertTrue(handler.delete(path.toUri(), conf, getTestUser()));
