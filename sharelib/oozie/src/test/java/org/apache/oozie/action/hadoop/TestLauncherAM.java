...
public class TestLauncherAM {
    ...
    private void setupActionOutputContents() throws IOException {
        ...
        given(localFsOperationsMock.getLocalFileContentAsString(any(File.class), eq(ACTIONOUTPUTTYPE_ID_SWAP), anyInt()))
            .willReturn(ACTIONOUTPUTTYPE_ID_SWAP);

        given(localFsOperationsMock.getLocalFileContentAsString(any(File.class), eq(ACTIONOUTPUTTYPE_OUTPUT), anyInt()))
            .willReturn(ACTIONOUTPUTTYPE_OUTPUT);

        given(localFsOperationsMock.getLocalFileContentAsString(any(File.class), eq(ACTIONOUTPUTTYPE_STATS), anyInt()))
    ...
    private void assertActionOutputDataPresentAndCorrect() {
        ...
        assertThat("extChildID output", ACTIONOUTPUTTYPE_EXT_CHILD_ID, equalTo(extChildId));
