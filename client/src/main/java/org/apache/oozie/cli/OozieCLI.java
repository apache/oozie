...
public class OozieCLI {
    ...
    /**
     * Entry point for the Oozie CLI when invoked from the command line. <p/> Upon completion this method exits the JVM
    ...
    /**
     * Run a CLI programmatically. <p/> It does not exit the JVM. <p/> A CLI instance can be used only once.
     *
     * @param args options and arguments for the Oozie CLI.
